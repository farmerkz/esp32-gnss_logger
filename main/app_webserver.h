...
/**
 * @brief Инициализация монитор-задачи веб-сервера.
 * Создает задачу, которая автоматически запускает и останавливает HTTP-сервер
 * в зависимости от состояния WiFi и конфигурации.
 */
